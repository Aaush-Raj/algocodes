...
def strYellow(skk):      print( "\033[93m {}\033[00m".format(skk))
def strLightPurple(skk): print( "\033[94m {}\033[00m".format(skk))
...
print(strBold("TESTINGMSG"))
print(strRed("TESTINGMSG"))
print(strGreen("TESTINGMSG"))
strYellow("TESTINGMSG")
strLightPurple("TESTINGMSG")
print(strPurple("TESTINGMSG"))
print(strLightGray("TESTINGMSG"))
print(strCyan("TESTINGMSG"))
print(strBlack("TESTINGMSG"))
# print(strCyan("TESTINGMSG"))
import sys
sys.exit()
