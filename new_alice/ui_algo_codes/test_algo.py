...
#Alice API
def user_creds(username,api_key):
	global alice
...
def main():
	...
	while not socket_opened:
		pass
	global bnf_script, username,password,twoFA,ltp_bnf,api_secret,bnf_call,order_placed,quantity
	...
	try:
		...
		while dt.datetime.now().time() <= dt.time(9,19,50):
			print("TIME IS LESS THEN 9:20")
			sleep(10)
