...
banknifty_nse_index = alice.get_instrument_by_symbol('NFO', 'Nifty Bank')
...
print(alice.place_order(TransactionType.Buy,ce_symbol,1,OrderType.Market,ProductType.Intraday))
print(bnf_nearest)
